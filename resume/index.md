...
>使用流行的`FairyGUI`框架，熟悉`DragonBones`龙骨换装。<br>
...
>客户端使用`Egret`引擎、`TypeScript`语言开发，`DragonBones`制作动画。服务端使用`NodeJS`语言、`MongoDB`数据库。<br>
>项目经历：《妖怪来了》《流言侦探》
...
>前期主要使用`Unity`引擎参与项目的预研开发，demo制作，技术探索。<br>
>后期使用`FlashBuilder`参与了TCG卡牌游戏的制作。<br>
>双端开发，负责前后端功能系统、数据库的设计与实现。<br>
>服务端使用`C#``MySQL`，客户端使用`AS3``Lua``Unity`<br>
